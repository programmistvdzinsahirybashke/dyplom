...
class Order(models.Model):
    ...
    order_finished_datetime = models.DateTimeField(default=None, blank=True, null=True,
    ...
    status = models.ForeignKey(to=Status, on_delete=models.SET_DEFAULT, blank=True, null=True, default=1,
                               limit_choices_to={'status_category': 'Заказ'}, verbose_name="Статус заказа")
...
class OrderItem(models.Model):
    ...
    status = models.ForeignKey(to=Status, on_delete=models.SET_DEFAULT, default=6,
                               limit_choices_to={'status_category': 'Услуга'}, verbose_name="Статус услуги")

    employee = models.ForeignKey(to=Employee, on_delete=models.SET_DEFAULT, blank=True, null=True, default=None,
                                 verbose_name="Назначен сотруднику")

    work_ended_datetime = models.DateTimeField(default=None, blank=True, null=True,
